...
ap.add_argument("-i", "--images1",required=True, help="path to images directory")
...
# detect people in the image：
    ...
    #judge if works
    difference = cv2.subtract(a, image)
    ...
    if result is True:
        ...
        e = a[1] // 3
        print(b,c,d,e)
        image2 = image[b-d:b + d, c-e:c + e]
        #cv2.imwrite("D:\PedestrianDetection\images\ p3.jpg", image2)
        ...
        cv2.imwrite('D:/PedestrianDetection/images' + str(m).zfill(8) + '.jpg', orig)
        cv2.imshow("bomb", image)
        cv2.waitKey(0)
